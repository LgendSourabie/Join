...
function subtaskIMGS() {
  ...
  checkNewSubtask();
  if (currentIMG === '../assets/extra_icons/subtasksPlus.svg') {
    element.setAttribute('src', '../assets/extra_icons/subtasks_check.svg');
  } else {
    element.setAttribute('src', '../assets/extra_icons/subtasksPlus.svg');
...
function checkNewSubtask() {
  let element = document.getElementById('subtasksPlusIMG');
  let currentIMG = element.getAttribute('src');
  if (currentIMG !== '../assets/extra_icons/subtasks_check.svg') return;
...
function changeCheckState(index) {
  ...
  if (currentState === '../assets/extra_icons/checkBox.svg') {
    field.setAttribute('src', '../assets/extra_icons/Check_button-white.svg');
  }
  if (currentState === '../assets/extra_icons/Check_button-white.svg') {
    field.setAttribute('src', '../assets/extra_icons/checkBox.svg');
  }
}

                        ...
                        <div class="assignedAddTask addTaskOverview">
                            ...
                            <div id="dropdown" class="dropdown" onclick="handleDropdownClick(this)">Select contacts to assign</div>
                              <div class="test6" onclick="handleDropdownClick(this)">
                                <img class="dropDownImg" src="../assets/extra_icons/arrow_drop_down.svg" alt="">
                              </div>
                    ...
                    <div class="containerRight">
                        ...
                        <div class="addTaskOverview">
                            ...
                            <div id="prio" class="prioSelection">
                                <img id="colorUrgentImg" onclick="prio('urgent'); changeColorPrio('colorUrgentImg','colorLowImg', 'colorMediumImg','../assets/extra_icons/urgent.svg', '../assets/extra_icons/urgent-white.svg','../assets/extra_icons/low.svg','../assets/extra_icons/medium.svg')" class="prio prioUrgentIMG testPrio" src="../assets/extra_icons/urgent.svg" alt="">
                                <img id="colorMediumImg" onclick="prio('medium'); changeColorPrio('colorMediumImg','colorUrgentImg','colorLowImg', '../assets/extra_icons/medium-yellow.svg', '../assets/extra_icons/medium.svg','../assets/extra_icons/urgent.svg','../assets/extra_icons/low.svg')" class="prio prioMediumIMG testPrio" src="../assets/extra_icons/medium-yellow.svg" alt="">
                                <img id="colorLowImg" onclick="prio('low'); changeColorPrio('colorLowImg','colorMediumImg','colorUrgentImg', '../assets/extra_icons/low.svg', '../assets/extra_icons/low-green.svg','../assets/extra_icons/medium.svg','../assets/extra_icons/urgent.svg')" class="prio prioLowIMG testPrio" src="../assets/extra_icons/low.svg" alt="">
                            </div>
                        </div>
                        ...
                        <div class="subtasksAddTask addTaskOverview">
                            ...
                            <div class="test_test">
                              ...
                              <img onclick="addNewSubtask(); changeSubtaskImg()" id="subtasksPlusIMG" class="subtasksPlusIMG" src="../assets/extra_icons/subtasksPlus.svg" alt="">
                            </button>
                              <button type="button" class="buttonSubtask" id="buttonSubtask" >
                              <img onclick="deleteSubtaskInput()" id="subtasksCancelIMG" class="subtasksCancelIMG" src="../assets/extra_icons/subtasks_cancel.svg" alt=""> 
                            </button>
                            </div>
                        ...
                        <div class="footerAddTask">
                            ...
                            <div class="footerAddTaskButtons">
                                ...
                                <button id="createTaskButton" class="createTaskButton">
                                    ...
                                    <img class="imgCheck" src="../assets/extra_icons/check.svg" alt="">
                                </button>
                            </div>
                        </div>
                </div>
...
<div id="privacy-render" class="task-info-section d-none-summary">
            <span id="privacy-page" class="virtualClass help-page">
              ...
              <a href="../summary.html"
                ><img id="return-btn" class="return-btn" src="../assets/arrow-left-line.svg" alt="Exit"
              /></a>
        ...
        <div class="section1">
            <div class="hiddenheadline">
              <div class="headlineAndAddTask">
                <h1>Board</h1>
                <button onclick="openAddtask()"><img src="../assets/add.svg" alt=""></button>
              </div>
            ...
            <div class="headline">
                ...
                <div class="addandsearch">
                    ...
                    <button onclick="openAddtask()">Add Task <img src="../assets/add.svg" alt=""></button>
                </div>
            </div>
        </div>
        <div class="todosection">
            <div class="todosplit">
                <div class="tablecolumntitle">
                    ...
                    <img onclick="openAddtask()" src="../assets/plusButton.svg" alt="">
                </div>
    ...
    <div class="d-flex">
        <div class="contacts-scroll-container">
            <div class="contacts-overview-container">
                <button class="add-new-contact" onclick="renderAddContact()">Add new contact<img src="../assets/addNewContact.svg"></button>
                <div id="contacts-overview"></div>
                </div>
                <button class="responsiv-contact-button" onclick="renderAddContact()"><img src="../assets/addNewContact.svg" alt=""></button>
            </div>

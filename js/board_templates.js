  ...
  return /*html*/ `
      <div class="overlay">
          <div class="overlaybutton">
              ...
              <img src="../assets/close.svg" alt="" onclick="closetodowindow()">
          </div>
          <h1>${tasks[i].title}</h1>
          ...
          <div class="overlaychange">
              ...
              <div class="overlayedit" onclick="edittask(${i})">
                  <img src="../assets/editcontact.svg" alt="">
                  <span>Edit</span>
              </div>
          </div>
      </div>
  ...
  return /*html*/ `
              <div class="addTaskOverviewContainer editTaskContainer">
                <div class="closeEditContainer">
                  <img class="closeEdit" src="../assets/close.svg" alt="" onclick="closetodowindow()">
                </div>

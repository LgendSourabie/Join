function showContactTemplate(i) {
  ...
  return /*html*/ `
              ...
              <div class="initial-name-container">
                  ...
                  <div class="name-edit-delete">
                      ...
                      <div class="edit-and-delete">
                          <div onclick="editContact(${i})"><img src="../assets/editContact.svg">Edit</div>
                          <div onclick="deleteContact(${i})"><img src="../assets/delete.svg">Delete</div>
                      </div>
                  </div>
              </div>
              </div>
          ...
          <div id="open-menu-contact-responsive"><button class="responsiv-contact-button" onclick="openMenuContactResponsive(${i})"><img src="../assets/three_points.svg" alt=""></button></div>
...
function openMenuContactResponsiveTemplate(i) {
  ...
  <div id="open-menu-contact-responsive-edit-delete">
    <div onclick="editContact(${i})"><img src="../assets/editContact.svg">Edit</div>
    <div onclick="deleteContact(${i}, true)"><img src="../assets/delete.svg">Delete</div>
  </div>
`;
}
  ...
  return /*html*/ `
        <div id="open-menu-contact-responsive">
            <button class="responsiv-contact-button" onclick="openMenuContactResponsive(${i})">
                <img src="../assets/three_points.svg" alt="">
            </button>
        </div>
    `;
}
      ...
      <div id="add-contact">
          ...
          <div class="add-contact-data">
            <div class="profile-icon-container" id="profile-icon-container">
              <img src="../assets/profileImageContacts.svg" alt="profile icon">
            </div>
                <form class="add-contact-data-inputs"  onsubmit="createContact()" action="#">
                  <div class="d-flex add-contact-input-container">
                    ...
                    <img src="../assets/name.svg" alt="telephone-icon">
                  </div>
                  <div class="d-flex add-contact-input-container">
                    <input type="email" placeholder="Email" class="add-contact-input" id="email-input" required>
                    <img src="../assets/email.svg" alt="telephone-icon">
                  </div>
                  <div class="d-flex add-contact-input-container">

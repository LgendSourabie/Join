...
function foraskcheckstate(initial, colors, field, elements, listeOption) {
  for (let i = 0; i < listeOption.length; i++) {
    ...
    if (elements.includes(option)) {
      ...
      document.getElementById(`checkBox${i}`).src = '../assets/extra_icons/Check_button-white.svg';
    }
  }
}
...
function checkprio(i) {
  if (tasks[i].prio.includes('urgent')) {
    changeColorPrio(
      ...
      'colorLowImg',
      'colorMediumImg',
      '../assets/extra_icons/urgent.svg',
      '../assets/extra_icons/urgent-white.svg',
      '../assets/extra_icons/low.svg',
      '../assets/extra_icons/medium.svg'
    );
  }
  if (tasks[i].prio.includes('medium')) {
    changeColorPrio(
      ...
      'colorUrgentImg',
      'colorLowImg',
      '../assets/extra_icons/medium-yellow.svg',
      '../assets/extra_icons/medium.svg',
      '../assets/extra_icons/urgent.svg',
      '../assets/extra_icons/low.svg'
    );
  ...
  if (tasks[i].prio.includes('low')) {
    changeColorPrio(
      ...
      'colorUrgentImg',
      '../assets/extra_icons/low.svg',
      '../assets/extra_icons/low-green.svg',
      '../assets/extra_icons/medium.svg',
      '../assets/extra_icons/urgent.svg'
    );
  }

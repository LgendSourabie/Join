...
function renderSubtaskHTMLTemplate(i, subtask) {
  return /*html*/ `
        <div class="newSubtaskContainerTwo" id="list${i}">
          <li id="link-${i}">${subtask}</li>
            <div class="hoverSubtask">
              <img class="subtaskNewContainerImgs" id="edit-${i}" onclick="editSubtask(${i})" src="../assets/extra_icons/penSubtasks.svg" alt="">
              <img class="subtaskNewContainerImgs"  onclick="deleteSubtask(${i})" src="../assets/extra_icons/deleteSubtasks.svg" alt="">
            </div>
        </div>
        <div id="test_test${i}" class="test_test editContainerSubtask d-none">
          ...
          <img onclick="changeSubtaskImg(); deleteSubtask()"  class="subtasksPlusIMGNew" src="../assets/extra_icons/deleteSubtasks.svg" alt="">
        </button>
          <button type="button" class="buttonSubtask">
            <div class="newSubtaskImgs">
          <img id="newSubtaskImgsHover" class="newSubtaskImgsHover" onclick="checkNewSubtaskEdit(${i})"   src="../assets/extra_icons/subtasks_check.svg" alt=""> 
          </div>
        </button>
        </div>
    `;
  ...
  return /*html*/ `
      <div class="option" id="cont${i}" onclick="updateBtn(${i});changeCheckState(${i})">
        ...
        <div class="spanContainer">
          ...
          <div class="test4">
            <div class="test5">
              <img id="checkBox${i}" src="../assets/extra_icons/checkBox.svg" alt="">
            </div>
          </div>
        </div>
      </div>
